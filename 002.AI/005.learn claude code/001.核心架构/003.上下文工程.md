---
date: 2026-04-03 17:21
<<<<<<< HEAD
modified: 2026-04-07 10:39
=======
modified: 2026-04-04 12:37
>>>>>>> origin/main
---

> 上下文工程是 Claude Code 能力的隐形支柱。模型的决策质量完全取决于它看到了什么上下文。

## [为什么上下文工程如此重要？](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e4%b8%ba%e4%bb%80%e4%b9%88%e4%b8%8a%e4%b8%8b%e6%96%87%e5%b7%a5%e7%a8%8b%e5%a6%82%e6%ad%a4%e9%87%8d%e8%a6%81%ef%bc%9f)

LLM 有一个固定大小的上下文窗口（Claude 当前最大 200 K token）。而一次真实的编码会话，可能涉及几十次文件读取、数百次工具调用，产生的原始文本量轻松超过百万 token——远远超出上下文窗口的容量。
...
## [3.1 上下文构建全景](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_31-%e4%b8%8a%e4%b8%8b%e6%96%87%e6%9e%84%e5%bb%ba%e5%85%a8%e6%99%af)
...
![[上下文构建全景.excalidraw|900]]
## [3.2 系统提示词的构建](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_32-%e7%b3%bb%e7%bb%9f%e6%8f%90%e7%a4%ba%e8%af%8d%e7%9a%84%e6%9e%84%e5%bb%ba)

系统提示词是上下文中最稳定的部分——它定义了模型"是谁"以及"该怎么做"。正因为稳定，它也是提示词缓存的最佳候选。Claude Code 的系统提示词构建在稳定性和灵活性之间做了精心平衡。

### [归属头（Attribution Header）](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e5%bd%92%e5%b1%9e%e5%a4%b4%ef%bc%88attribution-header%ef%bc%89)

基于指纹的身份标识，用于追踪请求来源。

### [CLI 系统提示词前缀](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=cli-%e7%b3%bb%e7%bb%9f%e6%8f%90%e7%a4%ba%e8%af%8d%e5%89%8d%e7%bc%80)

根据运行模式变化：交互式模式（REPL）和 `-p` 单次查询模式有不同的前缀指令。

### [系统提示词优先级](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e7%b3%bb%e7%bb%9f%e6%8f%90%e7%a4%ba%e8%af%8d%e4%bc%98%e5%85%88%e7%ba%a7)
...
### [静态/动态边界标记](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e9%9d%99%e6%80%81%e5%8a%a8%e6%80%81%e8%be%b9%e7%95%8c%e6%a0%87%e8%ae%b0)
...
### [Section-Level 缓存](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=section-level-%e7%bc%93%e5%ad%98)
...
### [系统上下文（`getSystemContext`）](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e7%b3%bb%e7%bb%9f%e4%b8%8a%e4%b8%8b%e6%96%87%ef%bc%88getsystemcontext%ef%bc%89)
...
### [用户上下文（`getUserContext`）](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e7%94%a8%e6%88%b7%e4%b8%8a%e4%b8%8b%e6%96%87%ef%bc%88getusercontext%ef%bc%89)
...
### [CLAUDE.md 发现机制](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=claudemd-%e5%8f%91%e7%8e%b0%e6%9c%ba%e5%88%b6)
...
### [上下文注入顺序](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e4%b8%8a%e4%b8%8b%e6%96%87%e6%b3%a8%e5%85%a5%e9%a1%ba%e5%ba%8f)
...
## [3.3 消息历史管理](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_33-%e6%b6%88%e6%81%af%e5%8e%86%e5%8f%b2%e7%ae%a1%e7%90%86)

Claude Code 不是简单地将所有历史消息发送给 API。它通过一系列机制管理消息列表，确保发送给 API 的消息格式合法、内容精简。

### [压缩边界（Compact Boundary）](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e5%8e%8b%e7%bc%a9%e8%be%b9%e7%95%8c%ef%bc%88compact-boundary%ef%bc%89)
...
### [消息规范化（`normalizeMessagesForAPI`）](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e6%b6%88%e6%81%af%e8%a7%84%e8%8c%83%e5%8c%96%ef%bc%88normalizemessagesforapi%ef%bc%89)
...
## [3.4 五级压缩流水线](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_34-%e4%ba%94%e7%ba%a7%e5%8e%8b%e7%bc%a9%e6%b5%81%e6%b0%b4%e7%ba%bf)

这是 Claude Code 上下文管理的核心机制。当对话越来越长，Token 使用量不断增长，五级压缩流水线逐级启动。设计哲学是**渐进式压缩**——先用成本最低的手段尝试释放空间，只在必要时才动用更重的武器。

![[五级压缩流水线.excalidraw|450]]

### [为什么按此顺序执行？](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e4%b8%ba%e4%bb%80%e4%b9%88%e6%8c%89%e6%ad%a4%e9%a1%ba%e5%ba%8f%e6%89%a7%e8%a1%8c%ef%bc%9f)
...
### [各级压缩详解](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e5%90%84%e7%ba%a7%e5%8e%8b%e7%bc%a9%e8%af%a6%e8%a7%a3)

#### [Level 1: Tool Result 预算裁剪](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=level-1-tool-result-%e9%a2%84%e7%ae%97%e8%a3%81%e5%89%aa)
...
**为什么选择持久化而非截断？** 截断意味着数据永久丢失——如果模型后来需要查看完整输出（比如在第 500 行发现了 bug），它无法恢复。持久化则保留了完整数据，模型可以随时使用 `Read` 工具读取磁盘文件来获取完整内容。2 KB 的预览给了模型足够的信息来判断是否需要查看完整结果。

此外，`applyToolResultBudget` 还会追踪已替换的工具结果（`ContentReplacementState`），确保会话恢复（resume）时做出与原始会话完全相同的替换决策，维持提示词缓存的稳定性。

#### [Level 2: History Snip](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=level-2-history-snip)
...
#### [Level 3: Microcompact](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=level-3-microcompact)
...
当缓存还没过期时（用户一直在活跃对话），情况完全不同。如果直接修改消息内容，会导致缓存键（cache key）变化，**使 100 K+ token 的缓存前缀全部失效**，需要重新上传和计费。
...
#### [Level 4: Context Collapse](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=level-4-context-collapse)
...
#### [Level 5: Autocompact](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=level-5-autocompact)
...
对于 200 K 上下文窗口 + 16 K 最大输出的模型，阈值约在 **171,000 Token**（约 85.5% 利用率）。可通过 `CLAUDE_AUTOCOMPACT_PCT_OVERRIDE` 环境变量按百分比覆盖。
...
![[压缩后恢复机制.excalidraw|1000]]

1. **恢复最近 5 个文件**：从压缩前的 `readFileState` 缓存中取出最近读取的 5 个文件，每个限 5 K Token，作为附件消息注入
2. **恢复所有已激活的技能**：预算 25 K Token（每个技能限 5 K Token），确保已加载的 [技能](https://windy3f3f3f3f.github.io/how-claude-code-works/#/./09-skills-system) 不丢失
...
**熔断器机制**：连续 3 次 autocompact 失败（`MAX_CONSECUTIVE_AUTOCOMPACT_FAILURES`），停止重试——上下文不可恢复地超限。这个熔断器来自真实数据：曾有 1,279 个会话连续失败超过 50 次（最高 3,272 次），浪费了约 250 K 次 API 调用/天。

### [关键常量](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e5%85%b3%e9%94%ae%e5%b8%b8%e9%87%8f)
...
## [3.5 Token 预算管理](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_35-token-%e9%a2%84%e7%ae%97%e7%ae%a1%e7%90%86)

Claude Code 维护精细的 Token 预算追踪：

### [输出 Token 预留（按模型）](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e8%be%93%e5%87%ba-token-%e9%a2%84%e7%95%99%ef%bc%88%e6%8c%89%e6%a8%a1%e5%9e%8b%ef%bc%89)
...
### [Token 估算算法](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=token-%e4%bc%b0%e7%ae%97%e7%ae%97%e6%b3%95)
...
### [Task Budget 跨压缩结转](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=task-budget-%e8%b7%a8%e5%8e%8b%e7%bc%a9%e7%bb%93%e8%bd%ac)
...
## [3.6 提示词缓存策略](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_36-%e6%8f%90%e7%a4%ba%e8%af%8d%e7%bc%93%e5%ad%98%e7%ad%96%e7%95%a5)

提示词缓存（Prompt Caching）是 Claude Code 性能和成本优化的核心。每次 API 请求的系统提示词 + 工具定义可能有 50-100 K token，如果每次都从头处理，既慢又贵。提示词缓存让服务端记住之前处理过的前缀，后续请求只需要处理新增部分。

但缓存有一个脆弱性：**前缀中任何一个字节的变化都会导致缓存失效**（cache miss），需要重新处理和缓存整个前缀。Claude Code 在多个层面精心维护缓存稳定性。

### [三模式系统提示词分割](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e4%b8%89%e6%a8%a1%e5%bc%8f%e7%b3%bb%e7%bb%9f%e6%8f%90%e7%a4%ba%e8%af%8d%e5%88%86%e5%89%b2)
...
|全局缓存|1 P + 有边界标记|**global**|null|
|默认|回退|org|org|

### [缓存 TTL](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e7%bc%93%e5%ad%98-ttl)
...
### [Beta Header 粘性锁存](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=beta-header-%e7%b2%98%e6%80%a7%e9%94%81%e5%ad%98)

Beta header（如 `cache-editing`、`thinking-clear`、`fast-mode` 等）会改变服务端的缓存键。如果一个 header 在请求 A 中发送但在请求 B 中不发送，缓存键就不同了——50-70 K token 的缓存前缀全部作废。
...
### [工具级 cache_control](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e5%b7%a5%e5%85%b7%e7%ba%a7-cache_control)
...
### [缓存断裂检测](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e7%bc%93%e5%ad%98%e6%96%ad%e8%a3%82%e6%a3%80%e6%b5%8b)
...
## [3.7 `<system-reminder>` 注入机制](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_37-ltsystem-remindergt-%e6%b3%a8%e5%85%a5%e6%9c%ba%e5%88%b6)
...
### [注入位置](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e6%b3%a8%e5%85%a5%e4%bd%8d%e7%bd%ae)
...
### [为什么用 XML 标签？](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=%e4%b8%ba%e4%bb%80%e4%b9%88%e7%94%a8-xml-%e6%a0%87%e7%ad%be%ef%bc%9f)
...
## [3.8 记忆预取](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_38-%e8%ae%b0%e5%bf%86%e9%a2%84%e5%8f%96)
...
## [3.9 反应式压缩](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_39-%e5%8f%8d%e5%ba%94%e5%bc%8f%e5%8e%8b%e7%bc%a9)
...
> **设计决策：压缩阈值是怎么确定的？**
> 
> 自动压缩的触发公式是 `tokens >= effectiveContextWindow - AUTOCOMPACT_BUFFER_TOKENS`，其中 `AUTOCOMPACT_BUFFER_TOKENS = 13,000`（`src/services/compact/autoCompact.ts`）。对于 200 K 上下文窗口，这意味着在约 **93.5%** 利用率时触发。为什么是 13 K？因为压缩本身需要预留输出空间——`MAX_OUTPUT_TOKENS_FOR_SUMMARY = 20,000`（基于 p 99.99 的压缩摘要输出为 17,387 tokens）。13 K buffer 确保触发压缩时还有足够空间完成当前工具执行和生成摘要。与此相关的还有 `WARNING_THRESHOLD_BUFFER_TOKENS = 20,000`——在压缩前 7 K tokens 就开始向用户显示警告。

> **设计决策：为什么 max_output_tokens 默认只用 8 K 而不是 32 K？**
> 
> `CAPPED_DEFAULT_MAX_TOKENS = 8,000`（`src/utils/context.ts`）。源码注释解释了原因：*"BQ p 99 output = 4,911 tokens, so 32 k/64 k defaults over-reserve 8-16× slot capacity."* API 服务端会根据 `max_output_tokens` 预留计算资源（slot），如果每个请求都声明 32 K 但实际只用 5 K，服务端的资源利用率极低。8 K 作为默认值覆盖了 99% 的实际需求。当模型确实因为 `max_tokens` 截断时，系统自动升级到 `ESCALATED_MAX_TOKENS = 64,000` 并清洁重试——这就是 MOT（Max Output Tokens）恢复机制。

## [3.10 设计洞察](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/03-context-engineering?id=_310-%e8%ae%be%e8%ae%a1%e6%b4%9e%e5%af%9f)
