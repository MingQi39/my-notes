...
## [2.1 全景：一次完整的交互](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_21-%e5%85%a8%e6%99%af%ef%bc%9a%e4%b8%80%e6%ac%a1%e5%ae%8c%e6%95%b4%e7%9a%84%e4%ba%a4%e4%ba%92)
...
## [2.2 双层生成器架构](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_22-%e5%8f%8c%e5%b1%82%e7%94%9f%e6%88%90%e5%99%a8%e6%9e%b6%e6%9e%84)

Claude Code 的查询系统采用**双层生成器架构**，清晰分离会话管理与查询执行：

![[双层生成器架构.excalidraw|300]]
...
## [2.3 QueryEngine：会话生命周期管理](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_23-queryengine%ef%bc%9a%e4%bc%9a%e8%af%9d%e7%94%9f%e5%91%bd%e5%91%a8%e6%9c%9f%e7%ae%a1%e7%90%86)

`src/QueryEngine.ts`（1,155 行）是对话的外壳。它的核心方法 `submitMessage()` 驱动一次完整的用户交互。

### [完整配置参数](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=%e5%ae%8c%e6%95%b4%e9%85%8d%e7%bd%ae%e5%8f%82%e6%95%b0)
...
### [submitMessage() 八阶段生命周期](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=submitmessage-%e5%85%ab%e9%98%b6%e6%ae%b5%e7%94%9f%e5%91%bd%e5%91%a8%e6%9c%9f)

`submitMessage()` 驱动一次完整的用户交互，分为 8 个阶段：

![[submitMessage() 八阶段生命周期.excalidraw|6000]]
...
## [2.4 query()：核心循环的实现](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_24-query%ef%bc%9a%e6%a0%b8%e5%bf%83%e5%be%aa%e7%8e%af%e7%9a%84%e5%ae%9e%e7%8e%b0)

`src/query.ts`（1,728 行）是 Claude Code 最复杂的单个模块，实现了一个**基于状态机的异步生成器循环**。

### [核心签名](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=%e6%a0%b8%e5%bf%83%e7%ad%be%e5%90%8d)
...
### [循环状态](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=%e5%be%aa%e7%8e%af%e7%8a%b6%e6%80%81)
...
### [不可变参数 vs 可变状态](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=%e4%b8%8d%e5%8f%af%e5%8f%98%e5%8f%82%e6%95%b0-vs-%e5%8f%af%e5%8f%98%e7%8a%b6%e6%80%81)
...
### [单次循环迭代流程](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=%e5%8d%95%e6%ac%a1%e5%be%aa%e7%8e%af%e8%bf%ad%e4%bb%a3%e6%b5%81%e7%a8%8b)

![[单次循环迭代流程.excalidraw|600]]

### [循环体代码走读](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=%e5%be%aa%e7%8e%af%e4%bd%93%e4%bb%a3%e7%a0%81%e8%b5%b0%e8%af%bb)

让我们跟着代码走一遍循环体的关键步骤：

**第一步：4 级压缩流水线**（详见[第 3 章](https://windy3f3f3f3f.github.io/how-claude-code-works/#/./03-context-engineering)）

每次循环迭代的入口处，消息列表依次经过 Tool Result Budget → Snip → Microcompact → Context Collapse → Autocompact。这是防御性设计——即使上一轮工具返回了 100 K Token 的输出，压缩流水线会在 API 调用前将其控制在预算内。
...
## [2.5 流式处理与并行工具执行](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_25-%e6%b5%81%e5%bc%8f%e5%a4%84%e7%90%86%e4%b8%8e%e5%b9%b6%e8%a1%8c%e5%b7%a5%e5%85%b7%e6%89%a7%e8%a1%8c)
...
### [StreamingToolExecutor 实现原理](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=streamingtoolexecutor-%e5%ae%9e%e7%8e%b0%e5%8e%9f%e7%90%86)
...
## [2.6 Feature Flag 条件加载](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_26-feature-flag-%e6%9d%a1%e4%bb%b6%e5%8a%a0%e8%bd%bd)
...
## [2.7 七个继续点（Continue Sites）](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_27-%e4%b8%83%e4%b8%aa%e7%bb%a7%e7%bb%ad%e7%82%b9%ef%bc%88continue-sites%ef%bc%89)
...
### [PTL（Prompt-Too-Long）恢复流程](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=ptl%ef%bc%88prompt-too-long%ef%bc%89%e6%81%a2%e5%a4%8d%e6%b5%81%e7%a8%8b)

![[PTL（Prompt-Too-Long）恢复流程.excalidraw|600]]

### [Max-Output-Tokens 恢复](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=max-output-tokens-%e6%81%a2%e5%a4%8d)

![[Max-Output-Tokens 恢复.excalidraw|600]]

## [2.8 错误扣留策略（Withholding）](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_28-%e9%94%99%e8%af%af%e6%89%a3%e7%95%99%e7%ad%96%e7%95%a5%ef%bc%88withholding%ef%bc%89)

这是 Claude Code 最巧妙的设计之一：**可恢复的错误不立即 yield 给上层**。

### [工作原理](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=%e5%b7%a5%e4%bd%9c%e5%8e%9f%e7%90%86)
...
### [一个实际场景](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=%e4%b8%80%e4%b8%aa%e5%ae%9e%e9%99%85%e5%9c%ba%e6%99%af)
...
3. **恢复策略 1 — 升级**：检查是否可以升级到 `ESCALATED_MAX_TOKENS`（64 K）。如果可以，直接用更大的 Token 限制重试，不注入任何用户消息
...
### [为什么这么设计？](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=%e4%b8%ba%e4%bb%80%e4%b9%88%e8%bf%99%e4%b9%88%e8%ae%be%e8%ae%a1%ef%bc%9f)

如果不做扣留，SDK 消费者（桌面应用、Bridge 模式）收到 `error` 类型的消息后会终止会话——即使后端的恢复循环还在运行，前端已经不再监听了。扣留机制确保前端只看到"干净"的结果流。

## [2.9 Token 使用追踪](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_29-token-%e4%bd%bf%e7%94%a8%e8%bf%bd%e8%b8%aa)
...
## [2.10 停止条件](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_210-%e5%81%9c%e6%ad%a2%e6%9d%a1%e4%bb%b6)
...
> **设计决策：为什么熔断阈值是 3 次？**
> 
> `MAX_CONSECUTIVE_AUTOCOMPACT_FAILURES = 3`（`src/services/compact/autoCompact.ts`）。源码注释引用了生产数据：*"BQ 2026-03-10: 1,279 sessions had 50+ consecutive failures (up to 3,272) in a single session, wasting ~250 K API calls/day globally."* 没有这个熔断器之前，压缩一旦进入失败循环，会无限重试——每次消耗一个完整的 API 调用（约 20 K output tokens）。3 次阈值在"给压缩服务恢复机会"和"避免资源浪费"之间取得平衡。
...
## [2.11 设计亮点总结](https://windy3f3f3f3f.github.io/how-claude-code-works/#/docs/02-agent-loop?id=_211-%e8%ae%be%e8%ae%a1%e4%ba%ae%e7%82%b9%e6%80%bb%e7%bb%93)
