---
date: 2026-04-04 12:59
modified: 2026-04-04 13:04
---

> 好用的 coding agent 不只是会写代码，而是会用低破坏性的方式改代码。

## [5.1 两种编辑工具](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_51-%e4%b8%a4%e7%a7%8d%e7%bc%96%e8%be%91%e5%b7%a5%e5%85%b7)
...
## [5.2 FileEditTool：Search-and-Replace 方法](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_52-fileedittool%ef%bc%9asearch-and-replace-%e6%96%b9%e6%b3%95)

FileEditTool 是 Claude Code 代码编辑的核心工具，采用精确字符串替换策略。

### [输入 Schema](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e8%be%93%e5%85%a5-schema)
...
### [工作原理](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%b7%a5%e4%bd%9c%e5%8e%9f%e7%90%86)
...
### [为什么 Search-and-Replace 优于其他方案](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e4%b8%ba%e4%bb%80%e4%b9%88-search-and-replace-%e4%bc%98%e4%ba%8e%e5%85%b6%e4%bb%96%e6%96%b9%e6%a1%88)

这个设计选择背后有深刻的工程考量：

#### [1. 低破坏性](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_1-%e4%bd%8e%e7%a0%b4%e5%9d%8f%e6%80%a7)
...
#### [2. 可验证性](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_2-%e5%8f%af%e9%aa%8c%e8%af%81%e6%80%a7)

每次编辑都有明确的"before"和"after"。用户可以精确看到什么被改了——这比看一个完整的新文件要容易得多。

#### [3. 抗幻觉](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_3-%e6%8a%97%e5%b9%bb%e8%a7%89)

模型需要提供文件中**实际存在**的精确字符串。如果模型"幻觉"了不存在的代码，编辑会直接失败并返回错误，而不是静默地写入错误内容。

#### [4. Token 效率](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_4-token-%e6%95%88%e7%8e%87)

对大文件的小修改，search-and-replace 只需要发送修改点附近的上下文，而不是整个文件内容。

#### [5. Git 友好](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_5-git-%e5%8f%8b%e5%a5%bd)

Search-and-replace 产生的 diff 最小化、最精确。自动化 PR 创建时，reviewer 看到的是干净的、有针对性的变更。

#### [与备选方案的对比](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e4%b8%8e%e5%a4%87%e9%80%89%e6%96%b9%e6%a1%88%e7%9a%84%e5%af%b9%e6%af%94)
...
**Unified diff/patch 格式**（如让模型直接输出 `@@ -1,3 +1,4 @@` 格式的 diff）：LLM 在生成这种严格格式时表现很差。Unified diff 要求精确的 hunk header（起始行号和行数），要求每一行都正确使用 `+` / `-` /空格前缀，上下文行数必须与 header 声明一致。任何一个字符的偏差都会导致整个 patch 无法应用。相比之下，search-and-replace 只需要模型提供两段自然语言级别的字符串——这正是 LLM 最擅长的任务形式。
...
### [输入预处理管线](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e8%be%93%e5%85%a5%e9%a2%84%e5%a4%84%e7%90%86%e7%ae%a1%e7%ba%bf)
...
### [完整验证管线](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%ae%8c%e6%95%b4%e9%aa%8c%e8%af%81%e7%ae%a1%e7%ba%bf)
...
### [唯一性约束](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%94%af%e4%b8%80%e6%80%a7%e7%ba%a6%e6%9d%9f)
...
### [实现细节：从匹配到写入](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%ae%9e%e7%8e%b0%e7%bb%86%e8%8a%82%ef%bc%9a%e4%bb%8e%e5%8c%b9%e9%85%8d%e5%88%b0%e5%86%99%e5%85%a5)

#### [引号标准化](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%bc%95%e5%8f%b7%e6%a0%87%e5%87%86%e5%8c%96)
...
#### [Diff 生成](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=diff-%e7%94%9f%e6%88%90)
...
#### [删除操作的特殊处理](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%88%a0%e9%99%a4%e6%93%8d%e4%bd%9c%e7%9a%84%e7%89%b9%e6%ae%8a%e5%a4%84%e7%90%86)
...
#### [编辑去重](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e7%bc%96%e8%be%91%e5%8e%bb%e9%87%8d)
...
## [5.3 FileWriteTool：全文件写入](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_53-filewritetool%ef%bc%9a%e5%85%a8%e6%96%87%e4%bb%b6%e5%86%99%e5%85%a5)
...
### [换行符策略：为什么 Write 始终使用 LF](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e6%8d%a2%e8%a1%8c%e7%ac%a6%e7%ad%96%e7%95%a5%ef%bc%9a%e4%b8%ba%e4%bb%80%e4%b9%88-write-%e5%a7%8b%e7%bb%88%e4%bd%bf%e7%94%a8-lf)
...
> _Previously we preserved the old file's line endings (or sampled the repo via ripgrep for new files), which silently corrupted e.g. bash scripts with `\r` on Linux when overwriting a CRLF file or when binaries in cwd poisoned the repo sample._
...
### [编码检测](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e7%bc%96%e7%a0%81%e6%a3%80%e6%b5%8b)
...
### [安全验证](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%ae%89%e5%85%a8%e9%aa%8c%e8%af%81)
...
## [5.4 多文件编辑协调](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_54-%e5%a4%9a%e6%96%87%e4%bb%b6%e7%bc%96%e8%be%91%e5%8d%8f%e8%b0%83)

当需要跨多个文件进行协调修改时（如重命名一个被广泛引用的函数），Claude Code 的策略是：

### [串行编辑](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e4%b8%b2%e8%a1%8c%e7%bc%96%e8%be%91)
...
### [原子性考量](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%8e%9f%e5%ad%90%e6%80%a7%e8%80%83%e9%87%8f)
...
### [级联编辑保护](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e7%ba%a7%e8%81%94%e7%bc%96%e8%be%91%e4%bf%9d%e6%8a%a4)
...
### [Worktree 隔离](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=worktree-%e9%9a%94%e7%a6%bb)
...
## [5.5 编辑前的读取要求](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_55-%e7%bc%96%e8%be%91%e5%89%8d%e7%9a%84%e8%af%bb%e5%8f%96%e8%a6%81%e6%b1%82)
...
### [没有这个约束会怎样？](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e6%b2%a1%e6%9c%89%e8%bf%99%e4%b8%aa%e7%ba%a6%e6%9d%9f%e4%bc%9a%e6%80%8e%e6%a0%b7%ef%bc%9f)
...
### [并发安全：文件状态缓存](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%b9%b6%e5%8f%91%e5%ae%89%e5%85%a8%ef%bc%9a%e6%96%87%e4%bb%b6%e7%8a%b6%e6%80%81%e7%bc%93%e5%ad%98)
...
## [5.6 缩进保持](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_56-%e7%bc%a9%e8%bf%9b%e4%bf%9d%e6%8c%81)
...
## [5.7 NotebookEditTool：Jupyter 编辑](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_57-notebookedittool%ef%bc%9ajupyter-%e7%bc%96%e8%be%91)

对于 Jupyter Notebook（`.ipynb` 文件），Claude Code 提供专门的 NotebookEditTool，它理解 Notebook 的 cell 结构，在 cell 级别进行精确编辑。

### [输入 Schema](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e8%be%93%e5%85%a5-schema-1)
...
### [工作原理](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e5%b7%a5%e4%bd%9c%e5%8e%9f%e7%90%86-1)
...
### [Cell 定位](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=cell-%e5%ae%9a%e4%bd%8d)
...
### [权限与安全](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e6%9d%83%e9%99%90%e4%b8%8e%e5%ae%89%e5%85%a8)
...
## [5.8 原子写入与 LSP 集成](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_58-%e5%8e%9f%e5%ad%90%e5%86%99%e5%85%a5%e4%b8%8e-lsp-%e9%9b%86%e6%88%90)
...
## [5.9 Diff 渲染](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_59-diff-%e6%b8%b2%e6%9f%93)

编辑完成后，Claude Code 需要在终端中向用户展示变更内容。这由 `StructuredDiff` 组件（`src/components/StructuredDiff.tsx`）负责。

### [数据结构](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e6%95%b0%e6%8d%ae%e7%bb%93%e6%9e%84)
...
### [行号调整](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e8%a1%8c%e5%8f%b7%e8%b0%83%e6%95%b4)
...
### [语法高亮](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e8%af%ad%e6%b3%95%e9%ab%98%e4%ba%ae)
...
### [终端渲染布局](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=%e7%bb%88%e7%ab%af%e6%b8%b2%e6%9f%93%e5%b8%83%e5%b1%80)
...
## [5.10 与工具系统的整合](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_510-%e4%b8%8e%e5%b7%a5%e5%85%b7%e7%b3%bb%e7%bb%9f%e7%9a%84%e6%95%b4%e5%90%88)

编辑工具在工具系统中的位置：

![[与工具系统的整合.excalidraw|1000]]

在 `acceptEdits` 权限模式下，编辑类工具自动批准，无需用户确认——这对信任度高的项目是极大的效率提升。

## [5.11 关键设计洞察](https://diwang.info/how-claude-code-works/#/docs/05-code-editing-strategy?id=_511-%e5%85%b3%e9%94%ae%e8%ae%be%e8%ae%a1%e6%b4%9e%e5%af%9f)
