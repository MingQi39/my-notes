...
## [6.1 Hook 事件全景](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_61-hook-%e4%ba%8b%e4%bb%b6%e5%85%a8%e6%99%af)

### [为什么是这 25 种事件？](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e4%b8%ba%e4%bb%80%e4%b9%88%e6%98%af%e8%bf%99-25-%e7%a7%8d%e4%ba%8b%e4%bb%b6%ef%bc%9f)
...
### [为什么需要这么多事件？](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e4%b8%ba%e4%bb%80%e4%b9%88%e9%9c%80%e8%a6%81%e8%bf%99%e4%b9%88%e5%a4%9a%e4%ba%8b%e4%bb%b6%ef%bc%9f)
...
## [6.2 Hook 类型](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_62-hook-%e7%b1%bb%e5%9e%8b)

Claude Code 支持四种可配置的 Hook 类型和两种编程式 Hook 类型。前四种可以写在 `settings.json` 中，后两种仅在 SDK/插件内部使用。

### [1. 命令 Hook（Command）](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_1-%e5%91%bd%e4%bb%a4-hook%ef%bc%88command%ef%bc%89)
...
### [2. 提示词 Hook（Prompt）](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_2-%e6%8f%90%e7%a4%ba%e8%af%8d-hook%ef%bc%88prompt%ef%bc%89)
...
### [3. Agent Hook](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_3-agent-hook)
...
### [4. HTTP Hook](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_4-http-hook)
...
### [5. 回调 Hook（Callback）— 仅限 SDK/插件](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_5-%e5%9b%9e%e8%b0%83-hook%ef%bc%88callback%ef%bc%89-%e4%bb%85%e9%99%90-sdk%e6%8f%92%e4%bb%b6)
...
### [6. 函数 Hook（Function）— 仅限会话内](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_6-%e5%87%bd%e6%95%b0-hook%ef%bc%88function%ef%bc%89-%e4%bb%85%e9%99%90%e4%bc%9a%e8%af%9d%e5%86%85)
...
### [通用字段说明](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e9%80%9a%e7%94%a8%e5%ad%97%e6%ae%b5%e8%af%b4%e6%98%8e)
...
## [6.3 Matcher 匹配器](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_63-matcher-%e5%8c%b9%e9%85%8d%e5%99%a8)

Matcher 是 Hook 系统的路由机制——决定一个 Hook 是否应该响应某个事件。

### [配置格式](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e9%85%8d%e7%bd%ae%e6%a0%bc%e5%bc%8f)
...
### [三种匹配模式](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e4%b8%89%e7%a7%8d%e5%8c%b9%e9%85%8d%e6%a8%a1%e5%bc%8f)
...
### [Matcher 与 `if` 条件的配合](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=matcher-%e4%b8%8e-if-%e6%9d%a1%e4%bb%b6%e7%9a%84%e9%85%8d%e5%90%88)
...
## [6.4 Hook 执行引擎](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_64-hook-%e6%89%a7%e8%a1%8c%e5%bc%95%e6%93%8e)

关键文件：`src/utils/hooks.ts`（核心调度）

Hook 执行经过 6 个阶段。下面逐一展开每个阶段的实现细节。

![[Hook 执行引擎.excalidraw|450]]

### [Stage 0：快速存在性检查](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=stage-0%ef%bc%9a%e5%bf%ab%e9%80%9f%e5%ad%98%e5%9c%a8%e6%80%a7%e6%a3%80%e6%9f%a5)
...
### [Stage 1：信任检查](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=stage-1%ef%bc%9a%e4%bf%a1%e4%bb%bb%e6%a3%80%e6%9f%a5)
...
> _"This centralized check prevents RCE vulnerabilities for all current and future hooks"_

### [Stage 2：Matcher 匹配与 Hook 收集](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=stage-2%ef%bc%9amatcher-%e5%8c%b9%e9%85%8d%e4%b8%8e-hook-%e6%94%b6%e9%9b%86)
...
### [Stage 3：Hook 去重](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=stage-3%ef%bc%9ahook-%e5%8e%bb%e9%87%8d)
...
### [Stage 4：输入构建与并行执行](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=stage-4%ef%bc%9a%e8%be%93%e5%85%a5%e6%9e%84%e5%bb%ba%e4%b8%8e%e5%b9%b6%e8%a1%8c%e6%89%a7%e8%a1%8c)
...
### [Stage 5：输出解析与退出码语义](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=stage-5%ef%bc%9a%e8%be%93%e5%87%ba%e8%a7%a3%e6%9e%90%e4%b8%8e%e9%80%80%e5%87%ba%e7%a0%81%e8%af%ad%e4%b9%89)

Hook 的输出协议由两部分组成：**退出码**和 **stdout 内容**。

#### [退出码语义](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e9%80%80%e5%87%ba%e7%a0%81%e8%af%ad%e4%b9%89)
...
#### [stdout 解析](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=stdout-%e8%a7%a3%e6%9e%90)
...
### [Stage 6：结果聚合与事件发射](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=stage-6%ef%bc%9a%e7%bb%93%e6%9e%9c%e8%81%9a%e5%90%88%e4%b8%8e%e4%ba%8b%e4%bb%b6%e5%8f%91%e5%b0%84)
...
### [超时配置](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e8%b6%85%e6%97%b6%e9%85%8d%e7%bd%ae)
...
## [6.5 Hook JSON Output Schema](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_65-hook-json-output-schema)

Hook 通过 stdout 输出 JSON 来控制 Claude Code 的行为。完整 schema 定义在 `src/types/hooks.ts` 中，使用 Zod 验证。

### [通用字段](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e9%80%9a%e7%94%a8%e5%ad%97%e6%ae%b5)
...
### [事件特定输出（hookSpecificOutput）](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e4%ba%8b%e4%bb%b6%e7%89%b9%e5%ae%9a%e8%be%93%e5%87%ba%ef%bc%88hookspecificoutput%ef%bc%89)
...
### [常用字段组合速查](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e5%b8%b8%e7%94%a8%e5%ad%97%e6%ae%b5%e7%bb%84%e5%90%88%e9%80%9f%e6%9f%a5)
...
### [数据流跟踪示例](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e6%95%b0%e6%8d%ae%e6%b5%81%e8%b7%9f%e8%b8%aa%e7%a4%ba%e4%be%8b)
...
## [6.6 信任模型与安全](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_66-%e4%bf%a1%e4%bb%bb%e6%a8%a1%e5%9e%8b%e4%b8%8e%e5%ae%89%e5%85%a8)

### [Hook 配置快照](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=hook-%e9%85%8d%e7%bd%ae%e5%bf%ab%e7%85%a7)
...
### [三层来源与策略控制](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e4%b8%89%e5%b1%82%e6%9d%a5%e6%ba%90%e4%b8%8e%e7%ad%96%e7%95%a5%e6%8e%a7%e5%88%b6)

`getHooksFromAllowedSources()` 从三个来源合并 Hook 配置：

![[三层来源与策略控制.excalidraw|900]]
...
## [6.7 PermissionRequest Hook 深度解析](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_67-permissionrequest-hook-%e6%b7%b1%e5%ba%a6%e8%a7%a3%e6%9e%90)

这是最强大的 Hook 类型——可以**程序化地控制工具权限**，在权限系统章节中参与竞速机制。

### [输入](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e8%be%93%e5%85%a5)
...
### [输出](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e8%be%93%e5%87%ba)
...
### [四种能力](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e5%9b%9b%e7%a7%8d%e8%83%bd%e5%8a%9b)
...
### [与权限系统的竞速](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e4%b8%8e%e6%9d%83%e9%99%90%e7%b3%bb%e7%bb%9f%e7%9a%84%e7%ab%9e%e9%80%9f)

PermissionRequest Hook 参与[权限系统的竞速机制](https://diwang.info/how-claude-code-works/#/./11-permission-security) ——与 UI 确认对话框和 ML 分类器同时运行，先完成的获胜。

![[与权限系统的竞速.excalidraw|1000]]

## [6.8 Stop Hook：采样后验证](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_68-stop-hook%ef%bc%9a%e9%87%87%e6%a0%b7%e5%90%8e%e9%aa%8c%e8%af%81)
...
## [6.9 实战模式](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_69-%e5%ae%9e%e6%88%98%e6%a8%a1%e5%bc%8f)

### [模式 1：CI 构建检查（asyncRewake）](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e6%a8%a1%e5%bc%8f-1%ef%bc%9aci-%e6%9e%84%e5%bb%ba%e6%a3%80%e6%9f%a5%ef%bc%88asyncrewake%ef%bc%89)
...
### [模式 2：上下文注入（additionalContext）](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e6%a8%a1%e5%bc%8f-2%ef%bc%9a%e4%b8%8a%e4%b8%8b%e6%96%87%e6%b3%a8%e5%85%a5%ef%bc%88additionalcontext%ef%bc%89)
...
### [模式 3：团队审计日志（HTTP Hook）](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e6%a8%a1%e5%bc%8f-3%ef%bc%9a%e5%9b%a2%e9%98%9f%e5%ae%a1%e8%ae%a1%e6%97%a5%e5%bf%97%ef%bc%88http-hook%ef%bc%89)
...
### [模式 4：LLM 安全评估（Prompt Hook）](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e6%a8%a1%e5%bc%8f-4%ef%bc%9allm-%e5%ae%89%e5%85%a8%e8%af%84%e4%bc%b0%ef%bc%88prompt-hook%ef%bc%89)
...
### [模式 5：PermissionRequest 自动审批](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e6%a8%a1%e5%bc%8f-5%ef%bc%9apermissionrequest-%e8%87%aa%e5%8a%a8%e5%ae%a1%e6%89%b9)
...
### [模式 6：输入改写（updatedInput）](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e6%a8%a1%e5%bc%8f-6%ef%bc%9a%e8%be%93%e5%85%a5%e6%94%b9%e5%86%99%ef%bc%88updatedinput%ef%bc%89)
...
## [6.10 Hook 与技能/插件的协作](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_610-hook-%e4%b8%8e%e6%8a%80%e8%83%bd%e6%8f%92%e4%bb%b6%e7%9a%84%e5%8d%8f%e4%bd%9c)

### [技能级 Hook](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e6%8a%80%e8%83%bd%e7%ba%a7-hook)
...
### [插件 Hook 的变量替换](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=%e6%8f%92%e4%bb%b6-hook-%e7%9a%84%e5%8f%98%e9%87%8f%e6%9b%bf%e6%8d%a2)
...
### [Hook 去重机制](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=hook-%e5%8e%bb%e9%87%8d%e6%9c%ba%e5%88%b6)
...
## [6.11 设计洞察](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_611-%e8%ae%be%e8%ae%a1%e6%b4%9e%e5%af%9f)

### [1. 事件驱动 + 双层匹配 = 精确控制](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_1-%e4%ba%8b%e4%bb%b6%e9%a9%b1%e5%8a%a8-%e5%8f%8c%e5%b1%82%e5%8c%b9%e9%85%8d-%e7%b2%be%e7%a1%ae%e6%8e%a7%e5%88%b6)

25 种事件 × matcher（粗粒度） × if 条件（细粒度），覆盖几乎所有扩展需求。不匹配的 Hook 在 spawn 进程之前就被过滤——这是真正的零成本抽象。

### [2. 退出码是最核心的通信协议](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_2-%e9%80%80%e5%87%ba%e7%a0%81%e6%98%af%e6%9c%80%e6%a0%b8%e5%bf%83%e7%9a%84%e9%80%9a%e4%bf%a1%e5%8d%8f%e8%ae%ae)

0/1/2 三个退出码的区分看似简单，实则精妙。它将信息传递划分为三个级别：静默成功（0）、告知用户（1）、要求模型处理（2）。这让 Hook 作者不需要学习复杂的 JSON 协议就能控制基本行为—— `exit 2` 比构建 JSON 对象简单得多。

### [3. 异步唤醒是创新设计](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_3-%e5%bc%82%e6%ad%a5%e5%94%a4%e9%86%92%e6%98%af%e5%88%9b%e6%96%b0%e8%ae%be%e8%ae%a1)

传统的 Hook 系统要么同步阻塞（慢），要么异步 fire-and-forget（无反馈）。asyncRewake 是第三种模式——后台运行 + 按需中断，退出码 2 的约定让长时间运行的检查只在失败时中断模型，完美平衡了性能和反馈。

### [4. 多层性能优化](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_4-%e5%a4%9a%e5%b1%82%e6%80%a7%e8%83%bd%e4%bc%98%e5%8c%96)
...
### [5. 安全设计遵循"全或无"原则](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_5-%e5%ae%89%e5%85%a8%e8%ae%be%e8%ae%a1%e9%81%b5%e5%be%aaquot%e5%85%a8%e6%88%96%e6%97%a0quot%e5%8e%9f%e5%88%99)

历史漏洞证明"大部分 Hook 需要信任"不够，必须是"所有 Hook 都需要信任"。配置快照、信任检查、环境变量白名单、CRLF 注入防护——每一层都假设攻击者可以控制前一层的输入。

### [6. Hook 是 Agent Loop 的横切关注点](https://diwang.info/how-claude-code-works/#/docs/06-hooks-extensibility?id=_6-hook-%e6%98%af-agent-loop-%e7%9a%84%e6%a8%aa%e5%88%87%e5%85%b3%e6%b3%a8%e7%82%b9)
