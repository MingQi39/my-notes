...
receivers = ['1127707363@qq.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
...
标准邮件需要三个头部信息： **From**, **To**, 和 **Subject** ，每个信息直接使用空行分割。通过实例化 smtplib 模块的 SMTP 对象 smtpObj 来连接到 SMTP 访问，并使用 sendmail 方法来发送信息。
...
my_sender='1127707363@qq.com'    # 发件人邮箱账号
my_pass = 'xxxxxxxxxx'              # 发件人邮箱密码
my_user='1127707363@qq.com'      # 收件人邮箱账号，我这边发送给自己
def mail():
    ret=True
    try:
